...
* For macOS:
    ...
    * Some `*.delta` files that encode [delta updates](understanding-updates.md#delta-updates).
* For Linux:
...
[^1]: In case you're wondering, market share for Windows 8 is so small that it can be safely ignored.
