...
upgrade to continue using the apt repositories generated by Conveyor. You can change the distribution used with the `app.linux.debian.distribution.name` key.

These new keys were added:

* `app.site.github.draft`
