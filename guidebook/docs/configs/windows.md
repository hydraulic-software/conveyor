...
**`app.windows.exe-installer-basename`** String, the base name of the EXE installer file generated by Conveyor, without the ".exe" extension. Defaults to the value of key `app.fsname`.
