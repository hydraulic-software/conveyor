...
!!! warning
    This is still in flux! Don't expect this to make sense yet!

## conveyor.conf

```hocon
include required("/stdlib/jdk/17/openjdk.conf")   // Use a stock OpenJDK Java 17 runtime.
include required("generated.conveyor.conf")       // Generated by running gradle hydraulic.samples.compose:writeConveyorConfig
